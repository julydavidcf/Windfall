...
enum class TEXTURE_ASSET_ID {
	...
	MAKEUPGAME = SAVE_GAME + 1,
	MAKEUPGAMEHOVER = MAKEUPGAME + 1,
	EXIT_GAME = MAKEUPGAMEHOVER + 1,
	...
	// ---------- Level Two dialogue --------------
	LEVELTWODIALOGUEONE = LEVELONEDIALOGUETEN + 1,
	...
	RED_PARTICLE = FREEROAMTUTORIAL + 1,
	...
	//--------
	SMOKE_PARTICLE = NECRO_TWO_SELECT + 1,
